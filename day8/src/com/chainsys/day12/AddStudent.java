...
public class AddStudent {
			...
			static String name;
			static String departmentB;
		    static int id;
			static int yearB;
			static int numberOfArrears;
		    static float gradePercentage;
			...
			public static String getDepartmentB() {
				return departmentB;}
...
*/
			public static int getNumberOfArrears() {
